...
/**
 * The MinusAgent class represents an agent that performs subtraction
...
public class MinusAgent implements Agent {
    ...
    /**
     * Constructs a MinusAgent with the specified subscription and publication topics.
    ...
    public void callback(String topic, Message msg) {
        ...
        // Perform subtraction and publish the result
